        ...
        <div class="container container-narrow py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <div class="markdown">
                        <p>We (the folks at Tabler) run a website hosting platform called <a
                                href="https://tabler.io">tabler.io</a> and would love for you to use it. Tabler.io's
                        ...
                        <p>The following terms and conditions govern all use of the tabler.io website and all content,
                            ...
                            and all other operating rules, policies (including, without limitation, <a
                                href="https://tabler.io/privacy-policy.html">Tabler's Privacy Policy</a> and procedures
                            that may be published from time to time by Tabler (collectively, the &quot;Agreement&quot;).
                        ...
                        <p>Please read this Agreement carefully before accessing or using our Services. By accessing or
                            ...
                            an offer by Tabler, acceptance is expressly limited to these terms.</p>
                        ...
                        <ul>
                            <li>
                                <p><strong>Responsibility of Contributors.</strong> If you post material to tabler.io,
                                    post links on tabler.io, or otherwise make (or allow any third party to make)
                                    ...
                                    but is not limited to text, photo, video, audio, or code. By using tabler.io, you
                                    represent and warrant that your Content and conduct do not violate these terms. By
                                    submitting Content to Tabler for inclusion on your account, you grant Tabler a
                                    ...
                                    promoting your changelog. If you delete Content, Tabler will use reasonable efforts
                                    to remove it from tabler.io, but you acknowledge that caching or references to the
                                    Content may not be made immediately unavailable. Without limiting any of those
                                    representations or warranties, Tabler has the right (though not the obligation) to,
                                    in Tabler's sole discretion, (i) reclaim your username or website's URL due to
                                    prolonged inactivity, (ii) refuse or remove any content that, in Tabler's reasonable
                                    opinion, violates any tabler policy or is in any way harmful or objectionable, or
                                    (iii) terminate or deny access to and use of Tabler.io to any individual or entity
                                    for any reason. Tabler will have no obligation to provide a refund of any amounts
                                    previously paid.</p>
                            </li>
                            <li>
                        ...
                        <p>Tabler has not reviewed, and cannot review, all of the material, including computer software,
                            ...
                            or effects. By operating our Services, Tabler does not represent or imply that it endorses
                        ...
                        <p>We have not reviewed, and cannot review, all of the material, including computer software,
                            made available through the websites and webpages to which Tabler links, and that link to
                            Tabler. Tabler does not have any control over those non-tabler websites, and is not
                            responsible for their contents or their use. By linking to a non-tabler website, Tabler does
                            ...
                            Trojan horses, and other harmful or destructive content. Tabler disclaims any responsibility
                            for any harm resulting from your use of non-tabler websites and webpages.</p>
                        <h3>5. Copyright Infringement and DMCA Policy.</h3>
                        <p>As Tabler asks others to respect its intellectual property rights, it respects the
                            intellectual property rights of others. If you believe that material located on or linked to
                            by tabler.io violates your copyright, you are encouraged to notify Tabler in accordance with
                            Tabler's Digital Millennium Copyright Act (&quot;DMCA&quot;) Policy. Tabler will respond to
                            all such notices, including as required or appropriate by removing the infringing material
                            or disabling all links to the infringing material. Tabler will terminate a visitor's access
                            to and use of the Website if, under appropriate circumstances, the visitor is determined to
                            be a repeat infringer of the copyrights or other intellectual property rights of Tabler or
                            others. In the case of such termination, Tabler will have no obligation to provide a refund
                            of any amounts previously paid to Tabler.</p>
                        ...
                        <p>This Agreement does not transfer from Tabler to you any Tabler or third party intellectual
                            ...
                            the parties) solely with Tabler. Tabler, tabler.io, the tabler.io logo, and all other
                            trademarks, service marks, graphics and logos used in connection with tabler.io or our
                            Services, are trademarks or registered trademarks of Tabler or Tabler's licensors. Other
                            ...
                            license to reproduce or otherwise use any Tabler or third-party trademarks.</p>
                        <h3>7. Changes.</h3>
                        ...
                        <p>Our Services are provided &quot;as is.&quot; Tabler and its suppliers and licensors hereby
                            disclaim all warranties of any kind, express or implied, including, without limitation, the
                            warranties of merchantability, fitness for a particular purpose and non-infringement.
                            Neither Tabler nor its suppliers and licensors, makes any warranty that our Services will be
                        ...
                        <p>By using Tabler, You are acknowledging that You have read and have agreed to <a
                                href="https://tabler.io/license.html">Tabler's License</a>, so please read them
                            carefully.</p>
                        ...
                        <p>You represent and warrant that (i) your use of our Services will be in strict accordance with
                            the Tabler Privacy Policy, with this Agreement, and with all applicable laws and regulations
