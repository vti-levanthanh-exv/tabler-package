            ...
            <div class="row row-cols-3 row-cols-md-4 row-cols-lg-6 g-3">
                ...
                <div class="col">
                    <a data-fslightbox="gallery" href="./static/photos/modern-home-office.jpg">
                        <!-- Photo -->
                        <div class="img-responsive img-responsive-1x1 rounded border"
                            style="background-image: url(./static/photos/modern-home-office.jpg)"></div>
                    </a>
                </div>
                <div class="col">
                ...
                <div class="col">
                    <a data-fslightbox="gallery" href="./static/photos/man-looking-out-to-sea.jpg">
                        <!-- Photo -->
                        <div class="img-responsive img-responsive-1x1 rounded border"
                            style="background-image: url(./static/photos/man-looking-out-to-sea.jpg)"></div>
                    </a>
                </div>
                <div class="col">
...
@section('scripts') 
    <script src="./dist/libs/fslightbox/index.js?1738096684" defer></script>
@endsection
