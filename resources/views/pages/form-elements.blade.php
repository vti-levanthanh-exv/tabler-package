                                                ...
                                                <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                                                    <label class="form-selectgroup-item flex-fill">
                                                        ...
                                                        <div class="form-selectgroup-label d-flex align-items-center p-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    <div class="font-weight-medium">Paweł Kuna
                                                                    </div>
                                                                    <div class="text-secondary">UI Designer
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <label class="form-selectgroup-item flex-fill">
                                                        ...
                                                        <div class="form-selectgroup-label d-flex align-items-center p-3">
                                                            ...
                                                            <div
                                                                class="form-selectgroup-label-content d-flex align-items-center">
                                                                <span class="avatar avatar-2 me-3">JL</span>
                                                                <div>
                                                                    <div class="font-weight-medium">Jeffie
                                                                        Lewzey</div>
                                                                    <div class="text-secondary">Chemical
                                                                        Engineer</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-selectgroup-label d-flex align-items-center p-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <span class="avatar avatar-2 me-3"
                                                                    style="background-image: url({{ asset('assets/static/avatars/000m.jpg') }})"></span>
                                                                <div>
                                                                    <div class="font-weight-medium">Mallory
                                                                        Hulme</div>
                                                                    <div class="text-secondary">Geologist IV
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-selectgroup-label d-flex align-items-center p-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <span class="avatar avatar-2 me-3"
                                                                    style="background-image: url({{ asset('assets/static/avatars/000m.jpg') }})"></span>
                                                                <div>
                                                                    <div class="font-weight-medium">Dunn Slane
                                                                    </div>
                                                                    <div class="text-secondary">Research Nurse
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-selectgroup-label d-flex align-items-center p-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <span class="avatar avatar-2 me-3"
                                                                    style="background-image: url({{ asset('assets/static/avatars/000m.jpg') }})"></span>
                                                                <div>
                                                                    <div class="font-weight-medium">Emmy Levet
                                                                    </div>
                                                                    <div class="text-secondary">VP Product
                                                                        Management</div>
                                                                </div>
                                                            </div>
                                                        </div>
	...
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1"><path d="M9 6l6 6l-6 6" /></svg>`,
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select type="text" class="form-select" id="select-people"
                                                    value="">
                                                    <option value="1"
                                                        data-custom-properties="&lt;span class=&#34;avatar avatar-xs&#34; style=&#34;background-image: url({{ asset('assets/static/avatars/000m.jpg') }})&#34;&gt;&lt;/span&gt;">
                                                        Paweł Kuna</option>
                                                    <option value="2"
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle">The version of Node.js that is used in the Build Step and
